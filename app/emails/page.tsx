    ...
    <div className="typical" style={{ minHeight: "100vh", background: "#FEFBF8", fontFamily: "var(--font-sans)" }}>
      ...
      <div style={{ padding: "40px 48px 80px" }}>
        ...
        {tab === "messages" ? (
          <div style={{ display: "grid", gridTemplateColumns: "280px 1fr", gap: 32, minHeight: 600 }}>
            <div style={{ border: "2px solid var(--typical-black)", borderRadius: 4, overflow: "hidden", background: "white", height: "fit-content" }}>
              ...
              <div style={{ maxHeight: 500, overflowY: "auto" }}>
                {THREADS.map((t) => (
                  ...
                  >
                    <div style={{ fontWeight: 700, fontSize: 13, color: "var(--typical-orange)", marginBottom: 6 }}>{t.from}</div>
                    <div style={{ fontSize: 12, color: "var(--fg-1)", lineHeight: 1.4, marginBottom: 8 }}>{t.subject}</div>
            ...
            <div>
              ...
              <div style={{ padding: 20, border: "2px solid var(--typical-black)", borderBottom: "none", borderRadius: "4px 4px 0 0", background: "#FEFBF8" }}>
                <h3 style={{ fontSize: 15, fontWeight: 700, margin: "0 0 12px 0", color: "var(--typical-orange)" }}>{selected.subject}</h3>
                <div style={{ display: "flex", justifyContent: "space-between", alignItems: "center" }}>
                  <div>
                    <div style={{ fontSize: 13, fontWeight: 600, marginBottom: 4 }}>{selected.senderName}</div>
                    <div style={{ fontSize: 12, color: "var(--fg-2)" }}>{selected.from}</div>
                  </div>
              ...
              <div style={{ padding: 24, border: "2px solid var(--typical-black)", borderTop: "1px solid var(--fg-2)", background: "white" }}>
                {selected.body.map((p, i) => (
                  <p key={i} style={{ margin: i === selected.body.length - 1 ? 0 : "0 0 16px 0", fontSize: 14, lineHeight: 1.7 }}>
                    {p}
                  </p>
                ))}
              </div>
          ...
          <div>
            <h2 style={{ fontSize: 18, fontWeight: 600, margin: "0 0 20px 0" }}>Email Automation</h2>
